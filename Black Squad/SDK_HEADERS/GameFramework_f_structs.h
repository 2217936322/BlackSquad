...
struct ADebugCameraHUD_eventPostRender_Parms
{
	...
	// struct FTraceHitInfo                            HitInfo;                                          		// 0x0044 (0x0020) [0x0000000000000000]              
	// class AActor*                                   HitActor;                                         		// 0x0064 (0x0004) [0x0000000000000000]              
	// class UMeshComponent*                           MeshComp;                                         		// 0x0068 (0x0004) [0x0000000004000000]              ( CPF_EditInline )
	// struct FVector                                  HitLoc;                                           		// 0x006C (0x000C) [0x0000000000000000]              
	// struct FVector                                  HitNormal;                                        		// 0x0078 (0x000C) [0x0000000000000000]              
	// unsigned long                                   bFoundMaterial : 1;                               		// 0x0084 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
struct AGameCheatManager_execAIDebugCamera_Parms
{
	...
	// class ADebugCameraController*                   DCC;                                              		// 0x0004 (0x0004) [0x0000000000000000]              
};
...
struct AGameCrowdAgent_execTakeDamage_Parms
{
	...
	struct FTraceHitInfo                               HitInfo;                                          		// 0x0024 (0x0020) [0x0000000000000090]              ( CPF_OptionalParm | CPF_Parm )
	class AActor*                                      DamageCauser;                                     		// 0x0044 (0x0004) [0x0000000000000090]              ( CPF_OptionalParm | CPF_Parm )
};
...
struct AGameExplosionActor_execDoExplosionDamage_Parms
{
	...
	// struct FTraceHitInfo                            HitInfo;                                          		// 0x00A4 (0x0020) [0x0000000000000000]              
	// class AKActorFromStatic*                        NewKActor;                                        		// 0x00C4 (0x0004) [0x0000000000000000]              
	// class UStaticMeshComponent*                     HitStaticMesh;                                    		// 0x00C8 (0x0004) [0x0000000004000000]              ( CPF_EditInline )
};
...
struct AGameExplosionActor_execGetPhysicalMaterial_Parms
{
	...
	// struct FTraceHitInfo                            OutHitInfo;                                       		// 0x0038 (0x0020) [0x0000000000000000]              
};
...
{
	struct FString                                     text_;                                            		// 0x0000 (0x000C) [0x0000000000400080]              ( CPF_Parm | CPF_NeedCtorLink )
};
...
struct ADebugCameraController_execNativeInputKey_Parms
{
	...
	// struct FTraceHitInfo                            HitInfo;                                          		// 0x0040 (0x0020) [0x0000000000000000]              
	// class AActor*                                   HitActor;                                         		// 0x0060 (0x0004) [0x0000000000000000]              
	// struct FVector                                  HitLoc;                                           		// 0x0064 (0x000C) [0x0000000000000000]              
	// struct FVector                                  HitNormal;                                        		// 0x0070 (0x000C) [0x0000000000000000]              
};
...
struct ADebugCameraController_execSecondarySelect_Parms
{
	...
	struct FTraceHitInfo                               HitInfo;                                          		// 0x0018 (0x0020) [0x0000000000000080]              ( CPF_Parm )
};
...
{
	class AActor*                                      InEnemy;                                          		// 0x0000 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	unsigned long                                      ReturnValue : 1;                                  		// 0x0004 (0x0004) [0x0000000000000580] [0x00000001] ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
};
...
struct AMobileDebugCameraHUD_eventPostRender_Parms
{
	...
	// struct FVector                                  HitNormal;                                        		// 0x0078 (0x000C) [0x0000000000000000]              
	// unsigned long                                   bFoundMaterial : 1;                               		// 0x0084 (0x0004) [0x0000000000000000] [0x00000001] 
	// unsigned long                                   bOldForceMobileHUD : 1;                           		// 0x0088 (0x0004) [0x0000000000000000] [0x00000001] 
};

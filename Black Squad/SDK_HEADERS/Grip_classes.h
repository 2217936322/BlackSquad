...
{
public:
	struct FPointer                                    NativeFramework;                                  		// 0x003C (0x0004) [0x0000000000001000]              ( CPF_Native )
...
{
public:
	struct FPointer                                    AIManager;                                        		// 0x01D4 (0x0004) [0x0000000000001000]              ( CPF_Native )
...
{
public:
	struct FPointer                                    BB;                                               		// 0x003C (0x0004) [0x0000000000001000]              ( CPF_Native )
...
{
public:
	float                                              DeltaTime;                                        		// 0x003C (0x0004) [0x0000000000000000]              
	float                                              Time;                                             		// 0x0040 (0x0004) [0x0000000000000000]              
	class UGripBlackboard*                             Blackboard;                                       		// 0x0044 (0x0004) [0x0000000000000000]              
	class UGripActionFramework*                        ActionFramework;                                  		// 0x0048 (0x0004) [0x0000000004400008]              ( CPF_ExportObject | CPF_NeedCtorLink | CPF_EditInline )
...
{
public:
	int                                                dummyVarJustSoTheClassDoesNotStartWithAnEnum;     		// 0x003C (0x0004) [0x0000000000000000]              
	unsigned long                                      childrenCollapsed : 1;                            		// 0x0040 (0x0004) [0x0000000000000000] [0x00000001] 
...
{
public:
	class UGripBTNode*                                 ParentNode;                                       		// 0x0044 (0x0004) [0x0000000000000000]              
	TArray< struct FNodeChild >                        Children;                                         		// 0x0048 (0x000C) [0x0000000004400048]              ( CPF_ExportObject | CPF_EditConstArray | CPF_NeedCtorLink | CPF_EditInline )
	float                                              RandomWeight;                                     		// 0x0054 (0x0004) [0x0000000000000000]              
	struct FName                                       NodeName;                                         		// 0x0058 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	struct FString                                     NodeDescription;                                  		// 0x0060 (0x000C) [0x0000000000420001]              ( CPF_Edit | CPF_EditConst | CPF_NeedCtorLink )
	struct FString                                     Comment;                                          		// 0x006C (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct FName                                       DefaultTitle;                                     		// 0x0078 (0x0008) [0x0000000000000000]              
	unsigned char                                      LastExecutionResult;                              		// 0x0080 (0x0001) [0x0000000000000000]              
	unsigned char                                      LastEvaluationResult;                             		// 0x0081 (0x0001) [0x0000000000000000]              
	int                                                DummyVarJustSoBaseClassDontEndWithAByteToAvoidCompilerWarning;		// 0x0084 (0x0004) [0x0000000000000000]              
...
{
public:
	unsigned long                                      Negate : 1;                                       		// 0x0088 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
...
{
public:
	unsigned long                                      PreConditionResult : 1;                           		// 0x008C (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
...
{
public:
	unsigned char                                      Lifetime;                                         		// 0x008C (0x0001) [0x0000000000000001]              ( CPF_Edit )
	struct FString                                     EventType;                                        		// 0x0090 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
...
{
public:
	struct FString                                     StateName;                                        		// 0x008C (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
...
{
public:
	struct FString                                     StateName;                                        		// 0x0088 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
...
{
public:
	unsigned long                                      bMoveNodesInBox : 1;                              		// 0x0088 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      bWrapped : 1;                                     		// 0x0088 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      bLimitFontSize : 1;                               		// 0x0088 (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
	unsigned long                                      bDrawBox : 1;                                     		// 0x0088 (0x0004) [0x0000000000000001] [0x00000008] ( CPF_Edit )
	unsigned long                                      bFilled : 1;                                      		// 0x0088 (0x0004) [0x0000000000000001] [0x00000010] ( CPF_Edit )
	...
	struct FColor                                      BorderColor;                                      		// 0x0098 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FColor                                      FillColor;                                        		// 0x009C (0x0004) [0x0000000000000001]              ( CPF_Edit )
...
{
public:
	float                                              MinCooldown;                                      		// 0x0088 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MaxCooldown;                                      		// 0x008C (0x0004) [0x0000000000000001]              ( CPF_Edit )
...
{
public:
	unsigned char                                      NextExecutionResult;                              		// 0x0088 (0x0001) [0x0000000000000000]              
	unsigned long                                      NextPreConditionResult : 1;                       		// 0x008C (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      Interruptible : 1;                                		// 0x008C (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	float                                              Duration;                                         		// 0x0090 (0x0004) [0x0000000000000001]              ( CPF_Edit )
...
{
public:
	unsigned char                                      Operator;                                         		// 0x0088 (0x0001) [0x0000000000000001]              ( CPF_Edit )
	float                                              Threshold;                                        		// 0x008C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              Value;                                            		// 0x0090 (0x0004) [0x0000000000000000]              
...
{
public:
	int                                                TimesToLoop;                                      		// 0x0088 (0x0004) [0x0000000000000001]              ( CPF_Edit )
...
public:
	unsigned char                                      Operator;                                         		// 0x0088 (0x0001) [0x0000000000000001]              ( CPF_Edit )
	int                                                Threshold;                                        		// 0x008C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                Value;                                            		// 0x0090 (0x0004) [0x0000000000000000]              
...
{
public:
	int                                                Cutoff;                                           		// 0x0094 (0x0004) [0x0000000000000001]              ( CPF_Edit )
...
{
public:
	TArray< class UGripBTNode* >                       AllTreeNodes;                                     		// 0x0088 (0x000C) [0x0000000004400048]              ( CPF_ExportObject | CPF_EditConstArray | CPF_NeedCtorLink | CPF_EditInline )
	unsigned long                                      bBeingEdited : 1;                                 		// 0x0094 (0x0004) [0x0000000000002000] [0x00000001] ( CPF_Transient )
...
{
public:
	struct FString                                     EventType;                                        		// 0x0088 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
...
{
public:
	unsigned long                                      RunAll : 1;                                       		// 0x0088 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
...
{
public:
	class UObject*                                     Owner;                                            		// 0x0088 (0x0004) [0x0000000000000000]              
	unsigned long                                      ConditionCache : 1;                               		// 0x008C (0x0004) [0x0000000000000000] [0x00000001] 
	int                                                NodeTitleOverride;                                		// 0x0090 (0x0004) [0x0000000000002000]              ( CPF_Transient )
...
{
public:
	TArray< class UGripBTScriptNode* >                 ScriptNodes;                                      		// 0x003C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 41096 ];

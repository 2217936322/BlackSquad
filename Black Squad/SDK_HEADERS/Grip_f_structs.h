...
{
	class UGripAFActionHandle*                         Handle;                                           		// 0x0000 (0x0004) [0x0000000000000080]              ( CPF_Parm )
...
{
	class UGripAFActionHandle*                         Action;                                           		// 0x0000 (0x0004) [0x0000000000000080]              ( CPF_Parm )
...
{
	class UGripBTInterface*                            BTInterface;                                      		// 0x0000 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	unsigned long                                      FirstExecution : 1;                               		// 0x0004 (0x0004) [0x0000000000000080] [0x00000001] ( CPF_Parm )
...
{
	class UGripBlackboard*                             Blackboard;                                       		// 0x0000 (0x0004) [0x0000000000000080]              ( CPF_Parm )
};
...
struct UGripBTScriptBehavior_eventExecutePass_Parms
{
	...
	unsigned long                                      PushToFinish : 1;                                 		// 0x0008 (0x0004) [0x0000000000000080] [0x00000001] ( CPF_Parm )
	unsigned char                                      ReturnValue;                                      		// 0x000C (0x0001) [0x0000000000000580]              ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
	// unsigned char                                   ExecRes;                                          		// 0x000D (0x0001) [0x0000000000000000]              
	// unsigned long                                   PreSuccess : 1;                                   		// 0x0010 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
{
	class UGripBTInterface*                            BTInterface;                                      		// 0x0000 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	unsigned long                                      PushToFinish : 1;                                 		// 0x0004 (0x0004) [0x0000000000000080] [0x00000001] ( CPF_Parm )
...
{
	class UGripBTInterface*                            BTInterface;                                      		// 0x0000 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	// class UGripBTScriptNode*                        Node;                                             		// 0x0004 (0x0004) [0x0000000000000000]              
};
...
{
	// class UGripBTScriptNode*                        Node;                                             		// 0x0000 (0x0004) [0x0000000000000000]              
};
...
{
	struct FString                                     infoType;                                         		// 0x0000 (0x000C) [0x0000000000400090]              ( CPF_OptionalParm | CPF_Parm | CPF_NeedCtorLink )
};
...
{
	int                                                BrainID;                                          		// 0x0000 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	// class AWorldInfo*                               WI;                                               		// 0x0004 (0x0004) [0x0000000000000000]              
	// class APlayerController*                        PC;                                               		// 0x0008 (0x0004) [0x0000000000000000]              
	// class ADebugCameraController*                   DCC;                                              		// 0x000C (0x0004) [0x0000000000000000]              
	// unsigned long                                   SwitchedToDebugCamera : 1;                        		// 0x0010 (0x0004) [0x0000000000000000] [0x00000001] 
	// struct FVector                                  ActorLocation;                                    		// 0x0014 (0x000C) [0x0000000000000000]              
	// struct FVector                                  ActorRotation;                                    		// 0x0020 (0x000C) [0x0000000000000000]              
	// struct FVector                                  NewCameraPos;                                     		// 0x002C (0x000C) [0x0000000000000000]              
	// struct FVector                                  NewCameraRotation;                                		// 0x0038 (0x000C) [0x0000000000000000]              
	// unsigned long                                   Result : 1;                                       		// 0x0044 (0x0004) [0x0000000000000000] [0x00000001] 
	// int                                             Offset;                                           		// 0x0048 (0x0004) [0x0000000000000000]              
};
...
{
	struct FString                                     Options;                                          		// 0x0000 (0x000C) [0x0000000000400090]              ( CPF_OptionalParm | CPF_Parm | CPF_NeedCtorLink )
};
...
{
	class APlayerController*                           OwnerCtrl;                                        		// 0x0000 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	struct FName                                       Key;                                              		// 0x0004 (0x0008) [0x0000000000000080]              ( CPF_Parm )
	unsigned char                                      Event;                                            		// 0x000C (0x0001) [0x0000000000000080]              ( CPF_Parm )

...
public:
	...
	unsigned char                                      UnknownData00[ 0xF0 ];                            		// 0x0A88 (0x00F0) MISSED OFFSET
...
{
public:
	unsigned char                                      LinkMode;                                         		// 0x01D4 (0x0001) [0x0000000000000000]              
	unsigned char                                      InLineMode;                                       		// 0x01D5 (0x0001) [0x0000000000000000]              
	unsigned char                                      OutLineMode;                                      		// 0x01D6 (0x0001) [0x0000000000000000]              
	unsigned char                                      ReceiveMode;                                      		// 0x01D7 (0x0001) [0x0000000000000000]              
	struct FPointer                                    Socket;                                           		// 0x01D8 (0x0004) [0x0000000000000002]              ( CPF_Const )
	int                                                Port;                                             		// 0x01DC (0x0004) [0x0000000000000002]              ( CPF_Const )
	struct FPointer                                    RemoteSocket;                                     		// 0x01E0 (0x0004) [0x0000000000000002]              ( CPF_Const )
	struct FPointer                                    PrivateResolveInfo;                               		// 0x01E4 (0x0004) [0x0000000000001002]              ( CPF_Const | CPF_Native )
	int                                                DataPending;                                      		// 0x01E8 (0x0004) [0x0000000000000002]              ( CPF_Const )
...
{
public:
	unsigned char                                      LinkState;                                        		// 0x01EC (0x0001) [0x0000000000000000]              
	struct FIpAddr                                     RemoteAddr;                                       		// 0x01F0 (0x0008) [0x0000000000000000]              
	class UClass*                                      AcceptClass;                                      		// 0x01F8 (0x0004) [0x0000000000000000]              
	TArray< unsigned char >                            SendFIFO;                                         		// 0x01FC (0x000C) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
	struct FString                                     RecvBuf;                                          		// 0x0208 (0x000C) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
...
// 0x001C (0x9014 - 0x8FF8)
class UTcpipConnection : public UNetConnection
{
public:
	unsigned char                                      UnknownData00[ 0x1C ];                            		// 0x8FF8 (0x001C) MISSED OFFSET
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 33528 ];
...
{
public:
	struct FString                                     ServerName;                                       		// 0x0214 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     Applications[ 0xA ];                              		// 0x0220 (0x0078) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     ApplicationPaths[ 0xA ];                          		// 0x0298 (0x0078) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	unsigned long                                      bEnabled : 1;                                     		// 0x0310 (0x0004) [0x0000000000004000] [0x00000001] ( CPF_Config )
	int                                                ListenPort;                                       		// 0x0314 (0x0004) [0x0000000000004000]              ( CPF_Config )
	int                                                MaxConnections;                                   		// 0x0318 (0x0004) [0x0000000000004000]              ( CPF_Config )
	int                                                DefaultApplication;                               		// 0x031C (0x0004) [0x0000000000004000]              ( CPF_Config )
	int                                                ExpirationSeconds;                                		// 0x0320 (0x0004) [0x0000000000004000]              ( CPF_Config )
	struct FString                                     ServerURL;                                        		// 0x0324 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class UWebApplication*                             ApplicationObjects[ 0xA ];                        		// 0x0330 (0x0028) [0x0000000000000000]              
	int                                                ConnectionCount;                                  		// 0x0358 (0x0004) [0x0000000000000000]              
	int                                                ConnID;                                           		// 0x035C (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 33531 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 33617 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 33631 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 33907 ];
...
public:
	...
	TArray< struct FMcpClashMobChallengeUserStatus >   TempChallengeUserStatusArray;                     		// 0x0174 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class UOnlineTitleFileCacheInterface*              FileCache;                                        		// 0x0180 (0x0008) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 33913 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 34122 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 34231 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 34391 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 34426 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 34708 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 34723 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 34936 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 34988 ];
...
{
public:
	class AWebServer*                                  WebServer;                                        		// 0x0214 (0x0004) [0x0000000000000000]              
	struct FString                                     ReceivedData;                                     		// 0x0218 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class UWebRequest*                                 Request;                                          		// 0x0224 (0x0004) [0x0000000000000000]              
	class UWebResponse*                                Response;                                         		// 0x0228 (0x0004) [0x0000000000000000]              
	class UWebApplication*                             Application;                                      		// 0x022C (0x0004) [0x0000000000000000]              
	unsigned long                                      bDelayCleanup : 1;                                		// 0x0230 (0x0004) [0x0000000000000000] [0x00000001] 
	int                                                RawBytesExpecting;                                		// 0x0234 (0x0004) [0x0000000000000000]              
	int                                                MaxValueLength;                                   		// 0x0238 (0x0004) [0x0000000000004000]              ( CPF_Config )
	int                                                MaxLineLength;                                    		// 0x023C (0x0004) [0x0000000000004000]              ( CPF_Config )
	int                                                ConnID;                                           		// 0x0240 (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 36423 ];

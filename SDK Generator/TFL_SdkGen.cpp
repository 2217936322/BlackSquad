...
int GetPropertyType ( UProperty* pProperty, string& sPropertyType, bool bFuncRet = false )
{
	...
	{ 
		if( ( (UStructProperty*) pProperty )->Struct != nullptr )
		{
			// count name
...
void GenerateFuncDef ( UClass* pClass )
{
	...
	for ( unsigned int i = 0; i < vFunction.size(); i++ )
	{
		...
		ssStreamBuffer0 << "\n\tProcessEvent ((UObject*)this, pFn" << sFunctionName << ", &" << sFunctionName << "_Parms, NULL );\n";
...
void Final_SdkHeaders()
{
	...
	fprintf(pFile, "#define GProcessEvent\t\tnullptr\n\n");
	fprintf(pFile, "typedef void(__thiscall *tProcessEvent)(class UObject *, class UFunction *, void *, void *);\n");
	fprintf(pFile, "tProcessEvent ProcessEvent = (tProcessEvent)GProcessEvent;\n");
